            ...
            >
              ...
              <View style={styles.listInfo}>
                <View style={styles.listTop}>
                  ...
                  {showSpotsPill && (
                    <View style={[styles.listSpotsBadge, { backgroundColor: colors.destructive }]}>
                      <Ionicons name={isFull ? 'lock-closed' : 'people'} size={11} color="#fff" />
                      <Text style={styles.listSpotsText}>
...
const styles = StyleSheet.create({
  ...
  listSpotsBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 12 },
  listSpotsText: { color: '#fff', fontSize: 11, fontFamily: 'Inter_700Bold' },
