      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.content}>
          ...
          <View style={[styles.card, { backgroundColor: colors.card }]}>
            ...
            <Row icon="star-outline" label="Feast Rewards" value={`${REWARDS_POINTS} pts`} onPress={() => router.push('/profile/rewards' as any)} />
            <Row icon="trophy-outline" label="Celebrations" onPress={() => router.push('/profile/celebrations' as any)} noBorder />
          </View>
